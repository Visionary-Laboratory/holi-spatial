#!/usr/bin/env python3
"""
运行 2d_iou_gyn_seperate_instance_scene_label_gyy.py 处理 DL3DV 下的9个场景
"""
...
def main():
    ...
    for scene in scenes:
        ...
        print(f"运行命令: python 2d_iou_gyn_seperate_instance_scene_label_gyy.py --scene {scene[:16]}...")
    ...
    print("=" * 60)
    print("\n运行统计脚本查看结果:")
    print("python stat_2d_iou_dl3dv.py")
