...
DATA_ROOT="${DATA_ROOT:-processed_dl3dv_ours/1K}"
SCENES_DIR="${SCENES_DIR:-pgsr_DL3DV_all/1K}"
CLASS_JSON_DIR="${CLASS_JSON_DIR:-Qwen3VL-32B-DL3DV/1K}"
MASK_ROOT="${MASK_ROOT:-sam3_masks_DL3DV/1K}"
OUTPUT_JSON_DIR="${OUTPUT_JSON_DIR:-output_DL3DV_new/1K}"
