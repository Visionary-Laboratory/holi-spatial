        ...
        for label, gt_mask in label_masks.items():
            ...
            for inst_idx, label_points in enumerate(instance_points_list):
                ...
                pred_mask = get_mask_from_sam(
                    ...
                    enable_pure_sam3=enable_pure_sam3,
                )
...
def main():
    ...
    parser.add_argument("--enable-pure-sam3", action="store_true", help="启用纯 SAM3 模式（不使用 bbox 提示，即使没有点云也继续处理）")
    ...
    elif args.gt_json.is_dir():
        args.gt_json = args.gt_json / f"{args.scene}.json"
    ...
    process_scene(
        ...
        enable_pure_sam3=args.enable_pure_sam3,
    )
