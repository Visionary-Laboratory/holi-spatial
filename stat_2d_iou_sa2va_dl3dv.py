#!/usr/bin/env python3
"""
统计 2d_iou_sa2va_outputs_dl3dv 目录下9个场景的平均 IoU
"""
...
def main():
    base_dir = Path("2d_iou_sa2va_outputs_sa2va")
    ...
    print(f"\n{'='*60}")
    print(f"统计目录: 2d_iou_sa2va_outputs_sa2va")
    print(f"{'='*60}\n")
    
    for scene in scenes:
        # Sa2VA 的输出文件名可能是 {scene}_2d_iou_sa2va.json
