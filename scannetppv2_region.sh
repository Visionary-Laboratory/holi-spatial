...
CLASS_JSON_DIR="${CLASS_JSON_DIR:-Qwen3VL-32B-Scannetppv2_region}"
MASK_ROOT="${MASK_ROOT:-sam3_masks_scannetppv2_region}"
OUTPUT_JSON_DIR="${OUTPUT_JSON_DIR:-output_scannetppv2_region_new}"
