...
"""
Post-process 3D bounding boxes into floor-aligned AABB-style boxes.
...
This script is the post-processing step after object/region annotation:
...
4) Writes the updated AABB-style JSON to output_dir, preserving all other fields.
