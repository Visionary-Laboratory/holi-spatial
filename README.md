...
### 5. Instance Descriptions and QA
...
python qa_generation/generate_3d_instance_description.py \
  ...
  --output_dir output_scannetppv2_new_with_descriptions \
...
- Descriptions: `output_scannetppv2_new_with_descriptions/<scene>.json`
